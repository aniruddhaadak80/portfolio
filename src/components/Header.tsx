...
import { Menu, X, Home, User, Settings, FolderGit2, FileText, Mail, Sun, Moon ,ScrollText, HandHeart , HeartHandshake} from 'lucide-react';
...
const Header: React.FC = () => {
  ...
  { name: 'Services', icon: <HeartHandshake size={18} />, color: 'text-violet-500', hoverColor: 'hover:text-violet-700' }, // Add Services
